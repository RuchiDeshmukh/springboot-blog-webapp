create table posts (created_on timestamp(6), id bigint generated by default as identity, updated_on timestamp(6), short_description varchar(255), title varchar(255) not null, url varchar(255), content clob not null, primary key (id))
